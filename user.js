...
(function() {
    ...
    const languages = {
        ...
        zh_cn: { title: 'GeoFS 计时器', start: '开始', stop: '结束', clear: '清空', current: '当前计时:', total: '总时长:', running: '进行中', noActive: '没有正在进行的计时', confirmNew: '上次记录未结束，是否结束上次并开始新记录？', confirmClear: '确定清空所有记录？', uiHidden: '界面已隐藏', uiShown: '界面已显示' },
        zh_tw: { title: 'GeoFS 計時器', start: '開始', stop: '結束', clear: '清空', current: '當前計時:', total: '總時長:', running: '進行中', noActive: '沒有正在進行的計時', confirmNew: '上次記錄未結束，是否結束上次並開始新記錄？', confirmClear: '確定清空所有記錄？', uiHidden: '介面已隱藏', uiShown: '介面已顯示' },
